...
# Evita dois run_cycle em simultâneo (1.º ciclo em thread + scheduler).
...
def main() -> None:
    ...
    O primeiro ciclo não bloqueia o arranque do HTTP: no Railway o health check
    precisa de porta aberta rapidamente; CoinGecko (429) pode demorar minutos.
    """
